import AboutMeImage from '../assets/computer.png'
export const AboutMe = () => { 
    ...
    <div className="flex flex-col align-items-center w-5/6 p-20 justify-content-center "> 
        ...
        <div className="flex justify-center">Welcome! I'm Gina, a lifetlong learner, self-starter, and creative builder with a deep love for figuring 
