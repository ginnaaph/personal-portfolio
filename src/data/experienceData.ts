...
export const experienceData: ExperienceItem[] = [
  ...
  {
    title: "Health Education Assistant",
    company: "Kaiser Permanente",
    location: "Santa Clara, CA",
    startDate: "October 2019",
    endDate: "September 2020",
    description:
      "Supported patients by connecting them with key resources, while learning how different departments within a healthcare system collaborate. This role deepened my understanding of operations and reinforced my interest in improving how systems serve people.",
  },

  {
    ...
    endDate: "May 2019",
    description:
      "Graduated with a degree in Public Health, driven by a desire to improve how people access care and create meaningful change in the healthcare space.",
  }
];
